        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center justify-between">
                    <h2 className="text-xl leading-tight font-semibold text-gray-800">Active Customers</h2>
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="overflow-hidden bg-white shadow-xs sm:rounded-lg">
                        <div className="p-6">
                            ...
                            {customers.length === 0 && <div className="py-8 text-center text-gray-500">No customers found</div>}
