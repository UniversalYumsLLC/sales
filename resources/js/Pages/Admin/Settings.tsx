                            ...
                            <div className="flex">
                                ...
                                <div className="ml-3">
                                    ...
                                    <div className="mt-2 text-sm text-blue-700">
                                        <p>You are running in the <strong>{environment.name}</strong> environment. Test mode is automatically enabled and cannot be disabled. All emails will be restricted to @universalyums.com addresses and the Fulfil sandbox will be used.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div>
                                    ...
                                    {environment.isLocal && (
                                        <p className="text-sm text-blue-600 mt-2 font-medium">
                                            Test mode is locked on in local environment.
                                        </p>
                                    )}
                                </div>
