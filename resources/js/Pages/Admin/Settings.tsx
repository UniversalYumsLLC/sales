...
export default function Settings({ settings, testModeInfo, environment }: Props) {
    ...
    return (
        <AuthenticatedLayout header={<h2 className="text-xl leading-tight font-semibold text-gray-800">Admin Settings</h2>}>
                        ...
                        <div className="p-6">
                            ...
                            <div className="flex items-center justify-between py-4">
                                <div>
                                    ...
                                    {environment.isLocal && (
                                        <p className="mt-2 text-sm font-medium text-blue-600">Test mode is locked on in local environment.</p>
                                    )}
                                </div>
                                <div className="flex items-center gap-2">
                                    ...
                                    <button
                                        ...
                                        className={`relative inline-flex h-6 w-11 shrink-0 rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none ${
