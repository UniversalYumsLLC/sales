        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center justify-between">
                    <h2 className="text-xl leading-tight font-semibold text-gray-800">Accounts Receivable</h2>
                ...
                <div className={`mx-auto max-w-7xl px-4 pt-6 sm:px-6 lg:px-8`}>
                    <div
                        className={`rounded-md p-4 ${
                            message.type === 'success' ? 'border border-green-200 bg-green-50' : 'border border-red-200 bg-red-50'
                        }`}
                    >
                        <div className="flex items-center justify-between">
                        ...
                        <div className="p-6">
                            ...
                            <div className="space-y-4">
                                {customers.map((customer) => (
                                    <div key={customer.id} className="rounded-lg border border-gray-200 bg-white">
                                        <div
                                            ...
                                            <div className="border-t border-gray-200 bg-gray-50 p-4">
                                                                    ...
                                                                    <td className="py-2 text-right text-sm">
                                                                        <div className="flex items-center justify-end gap-2">
                                                                            ...
                                                                            <button
                                                                                ...
                                                                                className="inline-flex items-center rounded border border-gray-300 bg-white px-2 py-1 text-xs font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50"
                                                                                title="Generate PDF"
                                                                            >
                                                                            ...
                                                                            <Menu as="div" className="relative inline-block text-left">
                                                                                <Menu.Button
                                                                                    className="inline-flex items-center rounded border border-transparent bg-indigo-600 px-2 py-1 text-xs font-medium text-white hover:bg-indigo-700 disabled:opacity-50"
                                                ...
                                                {customer.ap_contacts.length > 0 && (
                                                    <div className="mt-6 border-t border-gray-200 pt-4">
                                                        <h4 className="mb-3 text-xs font-medium text-gray-500 uppercase">AP Contacts</h4>
                                                        <div className="space-y-2">
                                                            {customer.ap_contacts
                                                                .filter((c) => c.type === 'portal')
                                                                .map((portalContact, idx) => (
                                                                    <div key={`portal-${idx}`} className="flex items-center gap-4 text-sm">
                                                            ...
                                                            {customer.ap_contacts
                                                                .filter((c) => c.type === 'inbox')
                                                                .map((contact, idx) => (
                                                                    <div key={`inbox-${idx}`} className="flex items-center gap-4 text-sm">
                            ...
                            {customers.length === 0 && <div className="py-8 text-center text-gray-500">No customers with outstanding invoices</div>}

                            {/* Last updated */}
                            <div className="mt-4 text-right text-xs text-gray-400">Last updated: {new Date(lastUpdated).toLocaleString()}</div>
                        </div>
                    </div>
                </div>
            </div>
