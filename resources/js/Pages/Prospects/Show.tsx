...
export default function Show({ prospect, statuses, allProducts, priceLists, paymentTerms, shippingTerms }: Props) {
    ...
    return (
            ...
            header={
                <div className="flex items-center justify-between">
                    <div className="gap-4 flex items-center">
                        ...
                        <h2 className="text-xl font-semibold leading-tight text-gray-800">{prospect.company_name}</h2>
                        <select
                            value={prospect.status}
                            onChange={(e) => handleStatusChange(e.target.value)}
                            disabled={saving}
                            className="bg-blue-100 px-3 py-0.5 text-xs font-medium text-blue-800 hover:bg-blue-200 focus:ring-blue-500 cursor-pointer rounded-full border-0 focus:ring-2 disabled:opacity-50"
                        >
                    ...
                    <button
                        ...
                        className="rounded-md bg-purple-600 px-4 py-2 text-sm font-medium text-white hover:bg-purple-700 focus:ring-purple-500 focus:ring-2 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
                    >
        ...
        >
            ...
            {promoting && (
                <div className="inset-0 bg-gray-900/50 fixed z-50 flex items-center justify-center">
                        ...
                        <div className="flex">
                            ...
                            <div className="pl-3 ml-auto">
                                <button
                                    ...
                                    className="rounded-md bg-red-50 p-1.5 text-red-500 hover:bg-red-100 inline-flex"
                                >
            ...
            <div className="py-12">
                <div className="max-w-7xl space-y-6 sm:px-6 lg:px-8 mx-auto">
                                    ...
                                    {!editingDetails ? (
                                        ...
                                        <>
                                            <input
                                                ...
                                                className={`mt-1 rounded-md shadow-sm focus:ring-indigo-500 block w-full ${allDetailsErrors.company_name ? 'border-red-300 focus:border-red-500' : 'border-gray-300 focus:border-indigo-500'}`}
                                            />
                                    ...
                                    {!editingDetails ? (
                                        ...
                                        <>
                                            <select
                                                ...
                                                className={`mt-1 rounded-md shadow-sm focus:ring-indigo-500 block w-full ${allDetailsErrors.discount_percent ? 'border-red-300 focus:border-red-500' : 'border-gray-300 focus:border-indigo-500'}`}
                                            >
                                    ...
                                    {!editingDetails ? (
                                        ...
                                        <>
                                            <select
                                                ...
                                                className={`mt-1 rounded-md shadow-sm focus:ring-indigo-500 block w-full ${allDetailsErrors.payment_terms ? 'border-red-300 focus:border-red-500' : 'border-gray-300 focus:border-indigo-500'}`}
                                            >
                                                <option value="">Select...</option>
                                                {paymentTerms.map((pt) => (
                                    ...
                                    {!editingDetails ? (
                                        ...
                                        <>
                                            <select
                                                ...
                                                className={`mt-1 rounded-md shadow-sm focus:ring-indigo-500 block w-full ${allDetailsErrors.shipping_terms ? 'border-red-300 focus:border-red-500' : 'border-gray-300 focus:border-indigo-500'}`}
                                            >
                                                <option value="">Select...</option>
                                    ...
                                    {!editingDetails ? (
                                        ...
                                        <>
                                            <input
                                                ...
                                                max="365"
                                                placeholder="days"
                                                className={`mt-1 rounded-md shadow-sm focus:ring-indigo-500 block w-full ${allDetailsErrors.shelf_life_requirement ? 'border-red-300 focus:border-red-500' : 'border-gray-300 focus:border-indigo-500'}`}
                                            />
                                    ...
                                    {!editingDetails ? (
                                        ...
                                        <>
                                            <input
                                                ...
                                                placeholder="https://..."
                                                className={`mt-1 rounded-md shadow-sm focus:ring-indigo-500 block w-full ${allDetailsErrors.vendor_guide ? 'border-red-300 focus:border-red-500' : 'border-gray-300 focus:border-indigo-500'}`}
                                            />
                                    ...
                                    {!editingDetails ? (
                                        ...
                                        <>
                                            <select
                                                ...
                                                className={`mt-1 rounded-md shadow-sm focus:ring-indigo-500 block w-full ${allDetailsErrors.broker ? 'border-red-300 focus:border-red-500' : 'border-gray-300 focus:border-indigo-500'}`}
                                            >
                                                <option value="">Select...</option>
                                        ...
                                        <div className="gap-4 grid grid-cols-2">
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="mt-1 w-32 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 block"
                                                    placeholder="0.0"
                                                />
                                            </div>
                                        </div>
                                                        ...
                                                        <div key={idx} className="gap-2 flex">
                                                            <div className="flex-1">
                                                                <input
                                                                    ...
                                                                    placeholder="Name"
                                                                    className={`rounded-md text-sm shadow-sm focus:ring-indigo-500 block w-full ${brokerContactsErrors[`broker_contacts.${idx}.name`] ? 'border-red-300' : 'border-gray-300'}`}
                                                                />
                                                            </div>
                                                            <div className="flex-1">
                                                                <input
                                                                    ...
                                                                    placeholder="Email"
                                                                    className={`rounded-md text-sm shadow-sm focus:ring-indigo-500 block w-full ${brokerContactsErrors[`broker_contacts.${idx}.value`] ? 'border-red-300' : 'border-gray-300'}`}
                                                                />
                                                            </div>
                                                            <button
                                                                type="button"
                    ...
                    {/* Contacts */}
                    <div className={`bg-white shadow-sm sm:rounded-lg overflow-hidden ${allContactsErrors.buyers ? 'ring-red-500 ring-2' : ''}`}>
                        <div className="p-6">
                            <div className="mb-4 flex items-center justify-between">
                            ...
                            {!editingContacts ? (
                                            ...
                                            {prospect.buyers && prospect.buyers.length > 0 ? (
                                                <ul className="space-y-3">
                                                    {prospect.buyers.map((contact, idx) => (
                                                        <li key={idx} className="text-sm border-gray-100 pb-2 last:pb-0 border-b last:border-0">
                                                            <div className="text-gray-900 font-medium">{contact.name}</div>
                                                            {contact.value && <div className="text-gray-500">{contact.value}</div>}
                                                            <div className="mt-1 gap-4 text-xs text-gray-400 flex">
                                ...
                                <div className="space-y-6">
                                                    ...
                                                    <div key={idx} className="gap-2 flex">
                                                        ...
                                                        <div className="flex-1">
                                                            <input
                                                                ...
                                                                className={`rounded-md text-sm shadow-sm focus:ring-indigo-500 block w-full ${contactsErrors[`buyers.${idx}.value`] ? 'border-red-300' : 'border-gray-300'}`}
                                                            />
                                                        </div>
                                                        <button
                                                            type="button"
                                                    ...
                                                    <div key={idx} className="gap-2 flex">
                                                        ...
                                                        <div className="flex-1">
                                                            <input
                                                                ...
                                                                placeholder="Email (optional)"
                                                                className={`rounded-md text-sm shadow-sm focus:ring-indigo-500 block w-full ${contactsErrors[`other.${idx}.value`] ? 'border-red-300' : 'border-gray-300'}`}
                                                            />
                                                        </div>
                                                        <button
                                                            type="button"
                                    ...
                                    <div className="pt-4 border-gray-200 border-t">
                                        <div className="mb-2 flex items-center justify-between">
                                            <h4 className="text-sm font-medium text-gray-700 gap-2 flex items-center">
                                                <span className="px-2 py-0.5 rounded text-xs bg-yellow-100 text-yellow-800 inline-flex items-center">
                                                    Uncategorized
                                                </span>
                                            </h4>
                                        ...
                                        {contactsForm.uncategorized.length === 0 ? (
                                            ...
                                            <div className="space-y-2">
                                                {contactsForm.uncategorized.map((contact, idx) => (
                                                    <div key={idx} className="gap-2 bg-yellow-50 p-2 rounded flex">
                                                        <div className="flex-1">
                                                            <input
                                                                type="text"
                                                                value={contact.name}
                                                                ...
                                                                placeholder="Name"
                                                                className={`rounded-md text-sm shadow-sm focus:ring-indigo-500 block w-full ${contactsErrors[`uncategorized.${idx}.name`] ? 'border-red-300' : 'border-gray-300'}`}
                                                            />
                                                        </div>
                                                        <div className="flex-1">
                                                            <input
                                                                ...
                                                                placeholder="Email"
                                                                className={`rounded-md text-sm shadow-sm focus:ring-indigo-500 block w-full ${contactsErrors[`uncategorized.${idx}.value`] ? 'border-red-300' : 'border-gray-300'}`}
                                                            />
                                                        </div>
                                                        <button
                                                            type="button"
                                    ...
                                    {prospect.products && prospect.products.length > 0 ? (
                                        <div className="gap-2 flex flex-wrap">
                                            {prospect.products.map((product) => (
                                                <span
                                                    key={product.id}
                                                    className="px-3 py-1 bg-gray-100 text-gray-800 text-sm inline-flex items-center rounded-full"
                                                >
