        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-gray-800">Prospects</h2>
                ...
                <div className="max-w-7xl sm:px-6 lg:px-8 mx-auto">
                    ...
                    <div className="bg-white shadow-sm sm:rounded-lg overflow-hidden">
                        <div className="p-6">
                                ...
                                <table className="divide-gray-200 min-w-full divide-y">
                                    <thead className="bg-gray-50">
                                        <tr>
                                            ...
                                            <th className="px-6 py-3 text-xs font-medium tracking-wider text-gray-500 text-left uppercase">Status</th>
                                        </tr>
                                    </thead>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="group relative">
                                                        <select
                                                            ...
                                                            className={`rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500 ${updatingId === prospect.id ? 'cursor-wait opacity-50' : ''} `}
                                                        >
                                                        ...
                                                        {statuses[prospect.status] && (
                                                            <div className="left-0 mb-2 absolute bottom-full z-10 hidden group-hover:block">
                                                                <div className="bg-gray-900 text-white text-xs rounded py-1 px-2 whitespace-nowrap">
                                                                    {statuses[prospect.status].description}
                                                                </div>
                                                                <div className="w-2 h-2 bg-gray-900 left-4 -bottom-1 absolute rotate-45 transform"></div>
                                                            </div>
                                                        )}
                                                    </div>
                                                </td>
                            ...
                            {prospects.length === 0 && (
                                <div className="py-8 text-gray-500 text-center">No prospects found. Click "New Prospect" to add one.</div>
                            )}
                        </div>
                    </div>
                </div>
