            ...
            <div className="flex max-h-[85vh] flex-col">
                ...
                <div className="flex items-center justify-between border-b border-gray-200 px-6 py-4">
                    <div className="flex min-w-0 items-center gap-3">
                        ...
                        <h3 className="truncate text-lg font-medium text-gray-900">{activeEmail?.subject || '(No subject)'}</h3>
                    </div>
                        ...
                        <div className="p-6">
                                ...
                                <div className="mb-4 rounded-md bg-gray-50 p-3">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {activeEmail.attachment_info.map((attachment, index) => (
                                            <div
                                                key={index}
                                                className="inline-flex items-center gap-1 rounded border border-gray-200 bg-white px-2 py-1 text-xs text-gray-600"
                                            >
                            ...
                            <div className="border-t border-gray-200 pt-4">
                                {activeEmail.body_html ? (
                                    ...
                                    <pre className="font-sans text-sm whitespace-pre-wrap text-gray-700">{activeEmail.body_text}</pre>
                                ) : (
